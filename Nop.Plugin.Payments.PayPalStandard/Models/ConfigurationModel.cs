...
namespace Nop.Plugin.Payments.PayPalStandard.Models
{
	public class ConfigurationModel : BaseNopModel
	{
		...
		{
			AddressModes = new List<SelectListItem>();
		}
		...
		[NopResourceDisplayName("Plugins.Payments.PayPalStandard.Fields.SelectShippingAddressMode")]
		public string SelectShippingAddressMode { get; set; }
		public bool SelectShippingAddressMod_OverrideForStore { get; set; }
		public IList<SelectListItem> AddressModes { get; set; }
	}
}